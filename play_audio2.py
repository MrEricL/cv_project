...
def playA(gesture=0):
    if gesture < 2:
        ...
        playsound("./sound/808-cymbal-06.wav", False)
    else:
...
def playB(gesture=0):
    if gesture < 2:
        ...
        playsound("./sound/808-hat-13.wav", False)
    else:
...
def playC(gesture=0):
    if gesture < 2:
        ...
        playsound("./sound/808-hat-09.wav", False)
    else:
...
def playD(gesture=0):
    if gesture < 2:
        ...
        playsound("./sound/808-tom-08.wav", False)
    else:
...
def playE(gesture=0):
    if gesture < 2:
        ...
        playsound("./sound/808-clap-08.wav", False)
    else:
...
def playF(gesture=0):
    if gesture < 2:
        ...
        playsound("./sound/808-kick-29.wav", False)
    else:
        playsound("./sound/808-conga-25.wav", False)
